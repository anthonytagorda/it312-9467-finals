...
<head>
    ...
    <link rel="icon" href='http://localhost:8080/it312-9467-finals/custodian/php/public/assets/images/r-icon.svg' type="image/svg">
    <link rel="stylesheet" href="public/styles/custodian_login.css">
</head>

<body>
    <div class="background">
        <img src='http://localhost:8080/it312-9467-finals/custodian/php/public/assets/images/samcis-bg.JPG' alt="SAMCIS img">
    </div>
    <div class="wrapper">
        <?php if ($is_invalid): ?>
            <script>
        ...
        <img src='http://localhost:8080/it312-9467-finals/custodian/php/public/assets/images/r-icon.svg' alt="Rentify Logo" class="logo-img">
